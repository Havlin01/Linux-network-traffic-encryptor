...
#define SERVER_CERT "server-dilithium-cert.pem" // Název souboru serverového certifikátu
#define SERVER_KEY "server-dilithium-key.pem"   // Název souboru serverového klíče
#define SERVER_CA_CERT "ca-cert.pem"  // Cesta k certifikátu certifikační autority klienta
